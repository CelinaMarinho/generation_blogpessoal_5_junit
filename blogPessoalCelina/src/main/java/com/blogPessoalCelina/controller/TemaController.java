...
public class TemaController {
	...
	@GetMapping
	public ResponseEntity<List<Tema>> getAll(){                      /* retorna todos os Objetos da Class Tema persistidos no DB, na tabela tb_temas.*/
		return ResponseEntity.ok(temaRepository.findAll());          /*executa o findAll(), retorna obj da Class Tema dentro da LIST. A List sempre será gerada (vazia ou não), o Mét sempre retornará o Status 200 🡪 OK.*/
